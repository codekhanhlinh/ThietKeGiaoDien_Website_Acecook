<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/SanPham_trcDN.Master" AutoEventWireup="true" CodeBehind="CTSanPham_TrcDN.aspx.cs" Inherits="Website_Acecook.CTSanPham_TrcDN" %>
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <div style="margin-left:50px; font-family:Bahnschrift">
                        ...
                        <br />
                        <asp:Label ID="lblTinhTrang" runat="server" CssClass="Tinhtrang" Width="200px"></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="lblGia" runat="server" Text="" CssClass="Gia"></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="Label1" runat="server" Text="Thành phần:" CssClass="TP"></asp:Label><br />
                        <asp:Label ID="lblTP" runat="server" Text="" CssClass="TP1"></asp:Label>
                    </div>  
